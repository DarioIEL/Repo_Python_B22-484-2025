...
//Esercizi Funzioni Parte1
/* ---------------------------------ES 0------------------------------------- */
//IL gioco dell'impiccato (7 tentativi per trovare la parola). Imposta un campo input all'interno del quale inserisci una singola lettera. Se la lettera esiste nella parola (o frase) stampa nella posizione corretta
